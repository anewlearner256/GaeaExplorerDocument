...
This class represents a C# script. It is the C# equivalent of the :ref:`GDScript<class_GDScript>` class and is only available in Mono-enabled GaaeExplorer builds.

See also :ref:`GaaeExplorerSharp<class_GaaeExplorerSharp>`.
