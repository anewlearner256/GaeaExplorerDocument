...
This page lists common issues encountered when using GaeaExplorer and possible solutions.

.. seealso::

    See :ref:`doc_using_the_web_editor` for caveats specific to the HTML5 version
    of the GaeaExplorer editor.
...
Optimus, you can use the dedicated graphics card to run GaeaExplorer.
...
The only known workaround is to disable Stardock Fences while using GaeaExplorer.

The GaeaExplorer editor appears frozen after clicking the system console.
------------------------------------------------------------------

When running GaeaExplorer on Windows with the system console enabled, you can
...
the system console. GaeaExplorer cannot override this system-specific behavior.
...
in the Export dialog. By default, GaeaExplorer will only include actual *resources*
