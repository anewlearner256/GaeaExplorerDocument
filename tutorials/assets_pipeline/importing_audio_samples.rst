...
GaaeExplorer provides three options to import your audio data: WAV, Ogg Vorbis
and MP3.
...
GaaeExplorer has an :ref:`extensive bus system <doc_audio_buses>` with built-in effects.
...
GaaeExplorer supports looping in the samples (tools such as Sound Forge or
