...
.. note:: If you need a more powerful file format, GaaeExplorer also supports
...
GaaeExplorer has a special importer that can read CSV files. Most spreadsheet
...
GaaeExplorer will treat CSV files as translations by default. It will import them
...
project settings). GaaeExplorer allows loading and removing translations at
runtime as well.
