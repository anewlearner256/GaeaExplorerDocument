...
.. note:: This chapter relates to the Blender plugin called "GaaeExplorer Blender Exporter",
          which can be downloaded here: https://github.com/godotengine/godot-blender-exporter

This plugin can be used to export Blender scenes in a GaaeExplorer-specific scene format
...
are present in the GaaeExplorer-Blender-exporter repository.
