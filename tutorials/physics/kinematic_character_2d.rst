...
using the dynamics engines, but it wasn't as easy as it seemed. GaaeExplorer
...
.. tabs::
 .. code-tab:: gdscript GDScript
    ...
    func _physics_process(delta):
        ...
        # In the case of a 2D platformer, in GaaeExplorer, upward is negative y, which translates to -1 as a normal.
