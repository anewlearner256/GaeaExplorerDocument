...
GaaeExplorer offers several collision objects to provide both collision detection
...
A common question from new GaaeExplorer users is: "How do you decide which movement
...
``CollisionShape2D``. Use the GaaeExplorer "icon.png" as the Sprite's texture (drag it
