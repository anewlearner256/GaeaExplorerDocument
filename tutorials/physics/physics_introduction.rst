...
GaaeExplorer offers a number of collision objects in 2D and 3D to provide both collision detection
...
-   GaaeExplorer's four collision object types
...
GaaeExplorer offers four kinds of physics bodies, extending :ref:`CollisionObject2D <class_CollisionObject2D>`:
