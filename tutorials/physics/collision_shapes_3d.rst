...
- The types of collision shapes available in 3D in GaaeExplorer.
- Using a convex or a concave mesh as a collision shape.
- Performance considerations regarding 3D collisions.

GaaeExplorer provides many kinds of collision shapes, with different performance and
accuracy tradeoffs.
...
GaaeExplorer provides the following primitive collision shape types:
...
multiple convex shapes instead of a concave collision shape. GaaeExplorer lets you use
...
in GaaeExplorer. **You can only use concave shapes within StaticBodies.** They will not
...
you can build a simplified collision mesh in a 3D modeler and have GaaeExplorer
...
.. seealso::
    ...
    GaaeExplorer can generate collision shapes for your imported 3D scenes
