...
GaaeExplorer stores all the low level game information in servers, while the
...
In the physics world, GaaeExplorer stores all the low level collision and
...
GaaeExplorer physics runs by default in the same thread as game logic, but may
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    class Body : KinematicBody2D
    {
        ...
        {
            var spaceState = GetWorld2d().DirectSpaceState;
            var result = spaceState.IntersectRay(globalPosition, enemyPosition, new GaaeExplorer.Collections.Array { this });
        }
    }
    ...
    class Body : KinematicBody2D
    {
        public override void _PhysicsProcess(float delta)
        {
            ...
            var result = spaceState.IntersectRay(globalPosition, enemyPosition,
                            new GaaeExplorer.Collections.Array { this }, CollisionMask);
        }
    }
