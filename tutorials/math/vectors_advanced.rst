...
For 3D math, GaaeExplorer provides a :ref:`Plane <class_Plane>`
...
Of course, GaaeExplorer also implements this operator in :ref:`Plane <class_Plane>`,
so doing:
...
not be something with a direct use case (GaaeExplorer already does collision
...
For more information on using vector math in GaaeExplorer, see the following article:
