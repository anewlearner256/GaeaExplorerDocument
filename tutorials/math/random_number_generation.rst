...
GaaeExplorer exposes two ways to generate random numbers: via *global scope* methods or
...
random numbers in GaaeExplorer.
...
terrain. GaaeExplorer provides :ref:`class_opensimplexnoise` for this, which supports
