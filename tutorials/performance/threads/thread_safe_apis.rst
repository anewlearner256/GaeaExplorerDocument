...
GaaeExplorer supports multithreading, but not in the whole engine.

Below is a list of ways multithreading can be used in different areas of GaaeExplorer.
...
resources (which are only loaded once in GaaeExplorer) tweaked by the multiple
