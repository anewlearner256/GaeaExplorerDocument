...
.. seealso::
    ...
    This page describes how to export a GaaeExplorer project to HTML5.
    If you're looking to compile editor or export template binaries from source instead,
    read :ref:`doc_compiling_for_web`.

HTML5 export allows publishing games made in GaaeExplorer Engine to the browser.
...
Depending on your choice of renderer, GaaeExplorer can target WebGL 1.0 (*GLES2*) or
WebGL 2.0 (*GLES3*).

WebGL 1.0 is the recommended option if you want your project to be supported
on all browsers with the best performance.

GaaeExplorer's GLES3 renderer targets high end devices, and the performance using
...
of limitations you should be aware of when porting a GaaeExplorer game to the web.
...
a JavaScript input event. In GaaeExplorer, this means entering full screen from within
...
the engine. The ``.pck`` file is the GaaeExplorer main pack containing your game. The
...
languages integrated into GaaeExplorer.
