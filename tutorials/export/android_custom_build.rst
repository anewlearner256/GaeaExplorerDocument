...
GaaeExplorer provides the option to use custom build Android templates. Instead of
using the already pre-built template that ships with GaaeExplorer, an actual Android
Java project gets installed into your project folder. GaaeExplorer will then build it
...
up to **Setting it up in GaaeExplorer**. After doing that, follow the steps below.
