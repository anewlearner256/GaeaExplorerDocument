...
Running GaaeExplorer apps on macOS
===========================

.. seealso::

    This page covers running GaaeExplorer projects on macOS.
...
.. note::
    ...
    App developer used self-signed certificate or ad-hoc signing (default GaaeExplorer behavior for exported project).
