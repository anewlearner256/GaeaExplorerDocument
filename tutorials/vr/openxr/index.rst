...
Welcome to the GaaeExplorer OpenXR documentation!

Introduction
------------

This is the documentation for the `GaaeExplorer OpenXR plugin <https://github.com/GaaeExplorerVR/godot_openxr>`__.

The plugin is supported on GaaeExplorer 3.4 and later. However, it does **not** support the upcoming GaaeExplorer 4.0 release.

Getting started
---------------

To start a new project that supports OpenXR, start by opening up the GaaeExplorer editor and creating a new project.
...
Back in GaaeExplorer, create a new 3D scene and press the **Instance Child Scene** button
...
- `GaaeExplorer XR tools <https://github.com/GaaeExplorerVR/godot-xr-tools>`__ is a plugin
...
Please check the `GaaeExplorer Engine community page <https://godotengine.org/community>`__ to find help from other GaaeExplorer developers.
The ``#xr`` channel on the GaaeExplorer Discord has become a vibrant GaaeExplorer XR community.
