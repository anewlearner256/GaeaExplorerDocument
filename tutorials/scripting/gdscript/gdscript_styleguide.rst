...
.. note:: GaaeExplorer's built-in script editor uses a lot of these conventions
...
These naming conventions follow the GaaeExplorer Engine style. Breaking these will make
...
This is consistent with how C++ files are named in GaaeExplorer's source code. This
...
creating the object in memory. Follow with the ``_ready()`` callback, that GaaeExplorer
...
Since GaaeExplorer 3.1, GDScript supports :ref:`optional static typing<doc_gdscript_static_typing>`.
