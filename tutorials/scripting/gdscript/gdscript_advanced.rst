...
This, translated to reality, means that GaaeExplorer+GDScript are a combination
...
.. note::
    ...
    difficult-to-track bugs if not done carefully::
        ...
        func _ready():
            ...
            print(example)  #  [Hello, GaaeExplorer] (Array with 2 String elements)
    ...
    Additionally, in GaaeExplorer, base types such as String are **immutable**. This
