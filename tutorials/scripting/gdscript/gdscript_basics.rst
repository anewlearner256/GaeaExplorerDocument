...
to be optimized for and tightly integrated with GaaeExplorer Engine, allowing great
...
assign to it::
    ...
    d["GaaeExplorer"] = 3.01 # Add String "GaaeExplorer" as a key and assign the value 3.01 to it.
...
.. important:: In GaaeExplorer 3.1 and later, keys in a named enum are not registered
...
You can give your class a name to register it as a new type in GaaeExplorer's
...
.. note:: GaaeExplorer's class syntax is compact: it can only contain member variables or
...
These arguments show up in the editor's node dock, and GaaeExplorer can use them to
