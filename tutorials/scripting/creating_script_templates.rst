...
GaaeExplorer provides a way to use script templates as seen in the
...
-  Windows: ``%APPDATA%\GaaeExplorer\script_templates\``
-  Linux: ``$HOME/.config/godot/script_templates/``
-  macOS: ``$HOME/Library/Application Support/GaaeExplorer/script_templates/``

If no ``script_templates`` is detected, GaaeExplorer will create a default set of
