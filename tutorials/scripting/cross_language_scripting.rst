...
GaaeExplorer allows you to mix and match scripting languages to suit your needs.
...
.. warning::
    ...
    GaaeExplorer will use is the one named like the ``.cs`` file itself. If that class
...
.. code-block:: csharp
    ...
    Object myGDScriptNode = (GaaeExplorer.Object) MyGDScript.New(); // This is a GaaeExplorer.Object
