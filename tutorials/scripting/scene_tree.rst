...
The way GaaeExplorer works internally is as follows. There is the
...
level and when making games in GaaeExplorer, writing your own MainLoop seldom makes sense.

SceneTree
---------

One of the ways to explain how GaaeExplorer works is that it's a high level
...
Most node operations in GaaeExplorer, such as drawing 2D, processing, or getting
