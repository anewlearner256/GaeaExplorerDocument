...
Having well-defined and consistent coding conventions is important for every project, and GaaeExplorer
is no exception to this rule.

This page contains a coding style guide, which is followed by developers of and contributors to GaaeExplorer
...
GaaeExplorer currently uses **C# version 7.0** in its engine and example source code. So, before we move to
...
.. code-block:: csharp
    ...
    // the existence of the `real_t` alias in GaaeExplorer, which can either be double or float
