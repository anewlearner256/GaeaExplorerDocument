...
GaaeExplorer's scene system, while powerful and flexible, has a drawback: there is no
...
.. note::
    ...
    GaaeExplorer won't make an AutoLoad a "true" singleton as per the singleton design
...
:download:`autoload.zip <files/autoload.zip>` and open it in GaaeExplorer.
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public class Global : GaaeExplorer.Node
    {
