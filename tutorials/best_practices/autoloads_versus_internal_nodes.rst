...
GaaeExplorer offers a feature to automatically load nodes at the root of your project,
...
organize a lot of functionality into a globally accessible object. GaaeExplorer offers
...
- **Static Data**: if you need data that is exclusive to one class, like a
  ...
  GaaeExplorer to create and manage static data otherwise.
...
Until GaaeExplorer 3.1, another use was just for convenience: autoloads have a global
