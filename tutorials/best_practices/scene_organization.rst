...
When GaaeExplorer users begin crafting their own scenes, they often run into the
following problem:
...
GaaeExplorer's node trees form an aggregation relationship, not one of composition.
