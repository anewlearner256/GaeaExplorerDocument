...
GaaeExplorer notifications
===================

Every Object in GaaeExplorer implements a
...
much so that GaaeExplorer exposes many of them with dedicated functions:
...
2. **Exported value assignment:** If instancing from a scene rather than
   a script, GaaeExplorer will assign the exported value to replace the initial
...
When instantiating a scene connected to the first executed scene, GaaeExplorer will
