...
Since GaaeExplorer has no restrictions on project structure or filesystem usage,
...
We will also cover using version control with GaaeExplorer.

Organization
------------

GaaeExplorer is scene-based in nature, and uses the filesystem as-is,
...
GaaeExplorer versions prior to 3.0 did the import process from files outside
...
To prevent GaaeExplorer from importing files contained in a specific folder, create
...
This can cause issues after exporting a project, since GaaeExplorer's PCK virtual
