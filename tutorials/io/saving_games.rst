...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public GaaeExplorer.Collections.Dictionary<string, object> Save()
    {
        return new GaaeExplorer.Collections.Dictionary<string, object>()
        {
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public void LoadGame()
    {
        ...
        {
            // Get the saved dictionary from the next line in the save file
            var nodeData = new GaaeExplorer.Collections.Dictionary<string, object>((GaaeExplorer.Collections.Dictionary)JSON.Parse(saveGame.GetLine()).Result);
