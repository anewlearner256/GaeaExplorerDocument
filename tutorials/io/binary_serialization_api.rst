...
GaaeExplorer has a simple serialization API based on Variant. It's used for
...
packet. Note that this assumes GaaeExplorer is compiled with single-precision floats,
which is the default. If GaaeExplorer was compiled with double-precision floats, the
