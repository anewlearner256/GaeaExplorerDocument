...
models, unwrapping can take a while on import. Nonetheless, GaaeExplorer will cache the UV2
...
Unwrap from within GaaeExplorer
~~~~~~~~~~~~~~~~~~~~~~~~

GaaeExplorer has an option to unwrap meshes and visualize the UV channels.
...
lot, the texture generation process can be quite costly within GaaeExplorer,
