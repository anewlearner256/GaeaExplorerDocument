...
There are many ways to procedurally generate geometry in GaaeExplorer. In this tutorial series
...
by an array of positions called "vertices". In GaaeExplorer, geometry is represented by Meshes.

What is a Mesh?
---------------

Many things in GaaeExplorer have mesh in their name: the :ref:`Mesh <class_Mesh>`, the :ref:`ArrayMesh <class_ArrayMesh>`,
...
GaaeExplorer provides different ways of accessing and working with geometry. More information on each will
