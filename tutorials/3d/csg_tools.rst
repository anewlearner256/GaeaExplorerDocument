...
Level prototyping is one of the main uses of CSG in GaaeExplorer. This technique allows
...
.. note:: The CSG nodes in GaaeExplorer are mainly intended for prototyping. There is
...
Like other features of GaaeExplorer, CSG is supported in the form of nodes. These are
the CSG nodes:
...
modelled in other software and imported into GaaeExplorer. Multiple materials are
...
You've successfully prototyped a room level with the CSG tools in GaaeExplorer.
...
GaaeExplorer's :ref:`doc_spatial_material` supports *triplanar mapping*, which can be
used to automatically apply a texture to arbitrary objects without distortion.
This is handy when using CSG as GaaeExplorer doesn't support editing UV maps on CSG
