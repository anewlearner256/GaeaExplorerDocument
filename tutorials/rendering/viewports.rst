...
For more information on how GaaeExplorer handles input, please read the :ref:`Input Event Tutorial<doc_inputevent>`.

Listener
--------

GaaeExplorer supports 3D sound (in both 2D and 3D nodes); more on this can be
...
If you know how the :ref:`Viewport <class_Viewport>` is going to be used, you can set its Usage to either 3D or 2D. GaaeExplorer will then
...
GaaeExplorer also provides a way of customizing how everything is drawn inside :ref:`Viewports <class_Viewport>` using “Debug Draw”.
