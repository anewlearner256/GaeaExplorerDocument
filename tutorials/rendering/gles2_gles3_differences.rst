...
.. note:: "GLES2" and "GLES3" are the names used in GaaeExplorer for the two OpenGL-based rendering backends.
...
project, or for a given viewport, GaaeExplorer will still use Low Dynamic Range (LDR) which limits
...
.. note:: Functions not in GLES2's GLSL were added with GaaeExplorers own shader standard library. These functions may perform worse in GLES2 compared to GLES3.
...
GaaeExplorer also provides many built-in variables and render modes. Some cannot be supported in GLES2. Below is a list of
