...
Cutout animation in GaaeExplorer
~~~~~~~~~~~~~~~~~~~~~~~~~

GaaeExplorer provides tools for working with cutout rigs, and is ideal for the workflow:
...
To solve these problems we'll use GaaeExplorer's skeletons.

Skeletons
~~~~~~~~~

In GaaeExplorer there is a helper to create "bones" between nodes. The bone-linked
...
Why does the hand lack a bone? In GaaeExplorer, a bone connects a
...
GaaeExplorer has connected the hip node to the scene root with a bone, and we don't
...
your cutout rigs. For more information on how the animation system in GaaeExplorer
