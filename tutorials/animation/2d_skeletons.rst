...
Dragonbones. From GaaeExplorer 3.1 onwards, though, this functionality is supported
built-in.

Why would you want to do skeletal animations directly in GaaeExplorer? The answer is
...
* The built-in skeletal system in GaaeExplorer is very efficient and designed for
  performance.
...
This happens because GaaeExplorer generates internal triangles that connect the points
