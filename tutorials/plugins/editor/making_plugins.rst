...
the project folder. GaaeExplorer provides a dialog for generating those files and
...
.. tabs::
 .. code-tab:: ini GDScript
    ...
    Description: A custom node made to extend the GaaeExplorer Engine.
...
The main script file will instruct GaaeExplorer what your plugin does in the editor
once it is active.
...
`addons/my_custom_node` folder as `icon.png`, or use the default GaaeExplorer logo
...
the dock. This is nothing more than a standard GaaeExplorer scene: just create
