...
GaaeExplorer allows for 3D audio streams that enter a specific Area node to send dry
...
GaaeExplorer can track velocity changes in the AudioStreamPlayer3D and Camera nodes.
