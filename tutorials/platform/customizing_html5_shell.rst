...
The default HTML page is available in the GaaeExplorer Engine repository at
...
- ``$GODOT_HEAD_INCLUDE``:
  ...
  HTML ``head`` element from the GaaeExplorer Editor, e.g. for different Web export presets.
