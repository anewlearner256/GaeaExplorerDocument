...
========================
Many of GaaeExplorer Editor functions can be executed with keyboard shortcuts. This page
...
.. note:: While Windows and Linux builds of the editor share most of the default settings,
          ...
          OS should find GaaeExplorer Editor's default key mapping intuitive.
