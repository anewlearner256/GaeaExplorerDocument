...
.. note:: If you have experience writing shaders and are just looking for an
          overview of how shaders work in GaaeExplorer, see the :ref:`Shading Reference
...
:ref:`CanvasItem <doc_canvas_item_shader>` shaders are used to draw all 2D
     objects in GaaeExplorer, while :ref:`Spatial <doc_spatial_shader>` shaders are
...
"Load", then select "Icon.png". For new projects, this is the GaaeExplorer icon. You
...
resource. Click on the sphere that appears. GaaeExplorer currently doesn't know whether
...
In GaaeExplorer, all shaders start with a line specifying what type of shader they are.
...
In GaaeExplorer you can override three functions to control how the shader operates;
