...
Since the GaaeExplorer shader language is close to C-style languages and GLSL, this
guide is inspired by GaaeExplorer's own GLSL formatting. You can view an example of a
GLSL file in GaaeExplorer's source code
...
.. note:: GaaeExplorer's built-in shader editor uses a lot of these conventions
