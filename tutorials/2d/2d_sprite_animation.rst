...
containing all the animation's frames. Both can be animated in GaaeExplorer with the AnimatedSprite class.
...
These examples illustrate the two classes you can use in GaaeExplorer for
