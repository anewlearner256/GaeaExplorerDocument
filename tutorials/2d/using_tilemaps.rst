...
When using a tileset, it's important that adjacent tiles match up. GaaeExplorer's default
...
Whenever GaaeExplorer updates a cell using an autotile, it first creates a pattern
