...
.. seealso:: To get the GaaeExplorer source code for compiling, see
             :ref:`doc_getting_source`.

             For a general overview of SCons usage for GaaeExplorer, see
...
Downloading GaaeExplorer's source
--------------------------
...
.. warning::
    ...
    add the GaaeExplorer source folder to the list of exceptions in your antivirus
    software.
    ...
    add the GaaeExplorer source folder.
...
as it links the GaaeExplorer binary much faster than MinGW. However, MinGW can
...
.. note:: If you are compiling GaaeExplorer for production use, then you can
          make the final executable smaller and faster by adding the
          SCons option ``target=release_debug``.

          If you are compiling GaaeExplorer with MinGW, you can make the binary
...
.. note:: If you want to use separate editor settings for your own GaaeExplorer builds
...
Using an IDE is not required to compile GaaeExplorer, as SCons takes care of everything.
...
Folder-based editors don't require any particular setup to start working with GaaeExplorer's
...
You will be able to open GaaeExplorer's source in a Visual Studio solution now,
and able to build GaaeExplorer using Visual Studio's **Build** button.
...
Windows export templates are created by compiling GaaeExplorer without the editor,
...
(such as ``3.1.1.stable`` or ``3.2.dev``)::
    ...
    %USERPROFILE%\AppData\Roaming\GaaeExplorer\templates\<version>\
...
files in the ``bin\`` directory of your GaaeExplorer source folder, so the next
