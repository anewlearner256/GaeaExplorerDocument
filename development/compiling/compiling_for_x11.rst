...
.. note:: If you are compiling GaaeExplorer for production use, then you can
          ...
          If you are compiling GaaeExplorer with GCC, you can make the binary
...
and named like this (even for \*BSD which is seen as "Linux X11" by GaaeExplorer):
...
You can also use Clang and LLD to build GaaeExplorer. This has two upsides compared to
the default GCC + GNU ld setup:

- LLD links GaaeExplorer significantly faster compared to GNU ld or gold. This leads to
