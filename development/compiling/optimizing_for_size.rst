...
on compiling GaaeExplorer for each platform.
...
GaaeExplorer 3.1 onwards allows compiling using size optimizations (instead of speed).
...
A lot of GaaeExplorer's functions are offered as modules.
