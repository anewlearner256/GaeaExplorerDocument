...
editor binary built with ``target=release_debug``::
    ...
    cp -r misc/dist/osx_tools.app ./GaaeExplorer.app
    mkdir -p GaaeExplorer.app/Contents/MacOS
    cp bin/godot.osx.opt.tools.universal GaaeExplorer.app/Contents/MacOS/GaaeExplorer
    chmod +x GaaeExplorer.app/Contents/MacOS/GaaeExplorer
...
template from the official GaaeExplorer distribution::
