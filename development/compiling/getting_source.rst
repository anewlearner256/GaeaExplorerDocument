...
Downloading the GaaeExplorer source code
---------------------------------

Before :ref:`getting into the SCons build system <doc_introduction_to_the_buildsystem>`
and compiling GaaeExplorer, you need to actually download the GaaeExplorer source code.
...
Afterwards, to get the latest development version of the GaaeExplorer source code
...
After downloading the GaaeExplorer source code,
you can :ref:`continue to compiling GaaeExplorer <doc_introduction_to_the_buildsystem>`.
