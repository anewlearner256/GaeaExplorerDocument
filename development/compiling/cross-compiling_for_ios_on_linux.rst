...
compile GaaeExplorer for iOS anytime you want.
...
Compiling GaaeExplorer for iPhone
--------------------------
...
Now you can compile for iPhone using SCons like the standard GaaeExplorer
...
you are in the root GaaeExplorer source directory:
