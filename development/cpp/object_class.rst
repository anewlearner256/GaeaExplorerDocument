...
.. seealso::
    ...
    This page describes the C++ implementation of objects in GaaeExplorer.
    Looking for the Object class reference? :ref:`Have a look here. <class_Object>`

General definition
------------------

:ref:`Object <class_object>` is the base class for almost everything. Most classes in GaaeExplorer
...
GaaeExplorer provides dynamic casting between Object-derived classes, for
example:
...
All objects in GaaeExplorer have a :ref:`_notification <class_Object_method__notification>`
