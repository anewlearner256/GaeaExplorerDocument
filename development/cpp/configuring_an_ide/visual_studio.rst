...
Visual Studio requires a solution file to work on a project. While GaaeExplorer does not come
with the solution file, it can be generated using SCons.

- Navigate to the GaaeExplorer root folder and open a Command Prompt or PowerShell window.
...
Visual Studio features a powerful debugger. This allows the user to examine GaaeExplorer's
...
you'd need to configure debugging options first. This is due to the fact that when the GaaeExplorer
