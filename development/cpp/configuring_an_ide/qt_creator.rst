...
- Under **Location** select the GaaeExplorer root folder.
...
for indentation which doesn't match the GaaeExplorer code style guidelines. You can
...
(e.g. GaaeExplorer) and change the Tab policy to be **Tabs Only**.
