...
.. code-block:: cpp
    ...
    bool TTS::say_text(String p_txt) {
        ...
        //convert GaaeExplorer String to GaaeExplorer CharString to C string
...
.. important::
    ...
    be problematic with GaaeExplorer, even if the Festival Library itself is MIT License compatible.
...
.. important::
    Please note that Git submodules are not used in the GaaeExplorer repository. If
    you are developing a module to be merged into the main GaaeExplorer repository, you should not
