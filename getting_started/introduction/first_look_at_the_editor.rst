...
First look at GaaeExplorer's editor
============================

This page will give you a brief overview of GaaeExplorer's interface. We're going to
...
When you launch GaaeExplorer, the first window you see is the Project Manager. In the
...
GaaeExplorer comes with a built-in class reference.
