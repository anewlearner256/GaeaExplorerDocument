...
Let's use instancing in practice to see how it works in GaaeExplorer. We invite
...
.. note:: If you change a value on the ``PhysicsMaterial`` of one instance, it
          ...
          Resources are another essential building block of GaaeExplorer games we will
          cover in a later lesson.

Scene instances as a design language
------------------------------------

Instances and scenes in GaaeExplorer offer an excellent design language, setting the
engine apart from others out there. We designed GaaeExplorer around this concept from
the ground up.
...
With GaaeExplorer, it's easy to iterate on your game like this, as all you need to do
...
all working with the GaaeExplorer editor.
