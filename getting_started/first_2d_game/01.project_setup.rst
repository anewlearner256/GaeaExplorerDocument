...
Launch GaaeExplorer and create a new project.
...
.. tabs::
 ...
 .. tab:: C#
    ...
    Ensure that you have the required dependencies to use C# in GaaeExplorer.
 ...
 .. tab:: GDNative C++
    ...
    Then you need to `download the GaaeExplorer C++ bindings <https://github.com/godotengine/godot-cpp>`_
