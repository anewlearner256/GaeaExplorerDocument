...
GaaeExplorer will display a warning icon next to the node in the scene tree. You can
...
.. note:: For this project, we will be following the GaaeExplorer naming conventions.
