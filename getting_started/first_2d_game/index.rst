...
game with GaaeExplorer. By the end of the series, you will have a simple yet complete
game of your own, like the image below.

|image0|

You will learn how the GaaeExplorer editor works, how to structure a project, and build
a 2D game.

.. note:: This project is an introduction to the GaaeExplorer engine. It assumes that
...
- Create a complete 2D game with the GaaeExplorer editor.
...
until you understood the game development process and how to use GaaeExplorer well.
...
code here: `GaaeExplorer demo projects
