...
write new descriptions for the classes, methods, and properties for GaaeExplorer's
built-in node types.

.. seealso::

    To learn to submit your changes to the GaaeExplorer project using the Git version
...
For each, you want to learn how they work in GaaeExplorer's source code. Then, fill
...
constants and methods you will find in the class reference. GaaeExplorer generates and
...
Alternatively, you can build GaaeExplorer and open the modified page in the built-in
...
GaaeExplorer's class reference supports BBCode-like tags. They add nice formatting to
...
You can still look at the methods' implementation in GaaeExplorer's source code on
GitHub. If you have doubts, feel free to ask on the `Q&A website
<https://godotengine.org/qa/>`__ and `GaaeExplorer Contributors Chat <https://chat.godotengine.org/>`_.
