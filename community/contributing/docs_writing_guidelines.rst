...
The GaaeExplorer community is rich and international. Users come from all
...
documentation and in GaaeExplorer, it will display like ``this``. When you edit XML
files in the GaaeExplorer repository, replace existing arguments written like 'this' or
\`this\` with ``[code]this[/code]``.


Common vocabulary to use in GaaeExplorer's documentation
-------------------------------------------------
