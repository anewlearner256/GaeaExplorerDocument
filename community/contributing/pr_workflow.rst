...
The so-called "PR workflow" used by GaaeExplorer is common to many projects using
...
organization of GaaeExplorer's Git repository.
...
edits to the source code - to contribute efficiently to GaaeExplorer, learning the
...
GaaeExplorer repo, with your GitHub username as namespace:
...
GaaeExplorer's project manager, which is coded in the ``editor/project_manager.cpp``
file.
...
`GaaeExplorer Contributors Chat <https://chat.godotengine.org/>`_ and ask for support :)
...
would want to know what happened in the GaaeExplorer codebase, or when and how a given
