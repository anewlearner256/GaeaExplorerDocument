...
This guide explains how to contribute to GaaeExplorer's documentation, be it by
...
.. warning:: The class reference's source files are in the `GaaeExplorer engine
             repository <https://github.com/godotengine/godot>`_. We generate
             the :ref:`GaaeExplorer API <toc-class-ref>` section of this documentation
             from them. If you want to update the description of a class, its
             methods, or properties, read
             :ref:`doc_updating_the_class_reference`.

What is the GaaeExplorer documentation
-------------------------------

The GaaeExplorer documentation is intended as a comprehensive reference manual for the
GaaeExplorer game engine. It is not meant to contain step-by-step tutorials, except for
...
apply to that specific version of GaaeExplorer.
...
edited here.** They are automatically generated from GaaeExplorer’s `XML class
...
-  **Good:** Understanding signals in GaaeExplorer
-  **Bad:** Understanding Signals In GaaeExplorer
...
attribution to "Juan Linietsky, Ariel Manzur and the GaaeExplorer community".
